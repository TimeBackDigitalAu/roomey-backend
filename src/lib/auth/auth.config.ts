...
export const AUTH_SUCCESS = {
  REGISTRATION: 'User registered successfully. Please verify your email and phone number.',
...
export const AUTH_ERRORS = {
  ...
  VERIFICATION_REQUIRED: 'Please verify your email and phone number before logging in',
